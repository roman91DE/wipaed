...
Interessenskonflikt: Agenten können den Anreiz besitzen, ihren Arbeitseinsatz möglichst gering zu halten (z.B. Freizeit, andere Arbeitgeber)
...
Screening: Mithilfe von zugänglichen Informationen versuchen Rückschlüsse auf die Eigenschaften des Vorstands zu ziehen (bisherige Performance analysieren und bewerten, wichtig ist zu berücksichtigen, ob externe Umstände einen signifikanten Einfluss hatten)
...
Entwicklung von DCGK Vorschriften -- Reglungssetzung
====================================================
...
**Welches Organ muss die Entsprechenserklärung abgeben? **
...
Eine unterjährige Änderung der DCGK Empfehlungen führt **nicht** zu
 ...
 **Vorstand** muss als gesetzlicher Vertreter die Erklärung zur
...
-   AR berichtet über das Ergebnis der **Prüfung von Rechnungslegung und
    Geschäftsführung**
...
Grenzen des eigenverantwortlichen Handelns des Vorstands
--------------------------------------------------------
...
|                      |                      | auf langfristige?)   |
+----------------------+----------------------+----------------------+
| Beeinflussbarkeit    | Prinzipiell gegeben, | Beeinflussbarkeit    |
...
Anreiz auf die Unternehmensleitung -- Wettbewerb
================================================
...
4.  Festlegung der Leistungskriterien die für die Gewährung von
...
Prüfung der Angemessenheit der Vorstandsvergütung anhand der Üblichkeit
-----------------------------------------------------------------------
...
-   Antwort ob CSR Maßnahme durchgeführt werden sollte, hängt der der
    Gewichtung der Wohlfahrt aus Sicht der Aktionäre ab (Wert β), der
    Höhe des finanziellen Nachteils aus der CSR Maßnahme und der Höhe
    des Wohlfahrtschadens ab
...
Messbarkeit präferenzbasierter CSR 
----------------------------------
...
-   Höhe des entstehenden finanziellen Nachteils: Π(sauber) - Π
    (dreckig)
-   Präferenzgewichtung der Shareholder: β
-   Höhe des negativen Gesamtwohlfahrtsschaden: d

Die **Höhe des entstandenen finanziellen Nachteils** ist zu berechnen
bzw. zu schätzen durch den Vergleich der beiden Alternativszenarios auf
den Unternehmensgewinn. Finanzberichtserstattung als
Informationsgrundlage

Der **Gesamtwohlfahrtsschaden** muss identifiziert und quantifiziert
werden. CSR Berichterstattung als Informationsgrundlage

**Soziale Präferenzen** der Aktionäre können durch Umfragen und
...
-   **Geringe Anstrengungen** des Vorstands: Geringe Profitabilität des
    Unternehmens auf Grund von fehlendem Arbeitseinsatzes des Vorstands
    kann zur Vertuschung als präferenzbasieret CSR Maßnahme „getarnt"
    werden
-   **Selbstbereicherung: **Vorstand führt CSR Maßnahmen aus
...
-   **Streben nach Prestige**: CSR Maßnahmen werden vom Vorstand aus
    Prestige Gründen durchgeführt und das Entscheidungskalkül der
    Aktionäre wird missachtet
-   E**ntrenchment**: CSR Maßnahme wird genutzt, um Verbündete zu
    gewinnen, die die Position des Vorstands stärken sollen
    (=Zementierung der eigenen Position)
...
-   Sofern nicht alle drei Parameter bekannt sind, kann die
    Vorteilhaftigkeit der CSR Maßnahme nicht vollständig beurteilt
    werden (Einschätzung kann jedoch vorgenommen werden bei Begründung)
-   Hinweise auf die Gefahr von Agency Konflikten bei der Durchführung
    von CSR Maßnahmen ohne vollständige Information über Parameter
    (geringe Anstrengung, Selbstbereicherung, Streben nach Prestige und
    Entrenchment)

Soziale Präferenzen der Aktionäre -- Aggregation und Risiken
------------------------------------------------------------
...
**Selbstselektion** durch die Aktionäre. Unternehmen können nach außen
kommunizieren in welchem Umfang sie bereit sind CSR Maßnahmen umzusetzen
(z.B. Unternehmensleitbild, CSR Berichtserstattung oder der Wahl der
Unternehmensform), die Aktionäre können demnach nur in die Unternehmen
investieren, deren Unternehmenspolitik zu ihren sozialen Präferenzen
passt

**Risiken bei der Umsetzung von präferenzbasierten CSR Maßnahmen**
...
anzunehmen, wenn der Preis p \> Π(sauber) ist und der zusätzliche
finanzielle Gewinn den Wohlfahrtsverlust ausgleicht
...
-   Aktionär ohne soziale Präferenzen kann ein Übernahmeangebot zum
    ...
    x), durch das Stoppen der CSR Maßnahme steigt der Unternehmenswert
    und er macht einen Gewinn in Höhe von (x -- Prämie)

**Soziale Präferenzen der Aktionäre am Beispiel von „Socially
...
-   Es entsteht ein Anreiz für Unternehmen nicht in eine Blacklist
    aufgenommen zu werden und keine unterdurchschnittlichen ESG Scores
    zu erzielen, da dadurch der Zufluss von signifikantem Anteil an
    Börsenkapital ausbleiben könnte

**Fallanwendung?**

-   Werden Aktien des Unternehmens von SRI Fonds gehalten? Falls ja
    steigt die durchschnittliche soziale Präferenz des Medianwähler und
    eine Durchführung von präferenzbasierten CSR könnte begünstigt
    werden
-   SRI Fonds kann Unternehmen außerdem direkt kontaktieren, um CSR
    Maßnahmen zu fördern
-   Anreiz an Vorstand ESG Score zu behalten oder nicht in eine
    Blacklist aufgenommen zu werden, um Finanzierung durch SRI Fonds
    nicht zu gefährden
...
Die CSR Berichterstattung erfolgt in Form der **Nichtfinanziellen
Erklärung** sowie der Erklärung der **Nichtfinanziellen
Leistungsindikatoren**

Nichtfinanzielle Erklärung
--------------------------

**Abgabepflicht**: Große kapitalmarktorientierte Unternehmen,
...
**Bestandteil des Lageberichts** oder einzeln als **separater Bericht**
...
**Inhalt: **Neben der Beschreibung des Geschäftsmodells muss das
Unternehmen auf mindestens 5 nichtfinanzielle Aspekte eingehen

1.  Umweltbelange (z.B. Emissionen, sparsamer Umgang mit Ressourcen,
    Anteil erneuerbarer Energien)
2.  Arbeitnehmerbelange (z.B. Arbeitsbedingungen, Gleichstellung)
3.  Sozialbelange (z.B. Dialog mit Kommunen und lokalen Gruppierungen)
4.  Achtung der Menschenrechte (z.B. Überprüfung von Arbeitsbedingungen
    in Lieferantenkette)
5.  Bekämpfung von Korruption und Bestechung (z.B. Kontrollmechanismen
    und Maßnahmen)

  Zu allen 5 Aspekten hat das Unternehmen zu erklären:

-   welches **Konzept** verfolgt wurde und welche **Ergebnisse** (=CSR
    Aktivität) damit erzielt wurden,
-   **Risiken** mit potential schwerwiegenden Folgen, die **aus
    Geschäftstätigkeit und den Geschäftsbeziehungen** (insb.
    Lieferkette) entstehen könnten,
-   Darstellung bedeutsamer **Leistungsindikatoren** und **Zusammenhänge
    zum Jahresabschluss**
...
**Wesentlichkeit** und der **Relevanz für Stakeholder**

Nichtfinanzielle Leistungsindikatoren
-------------------------------------

**Abgabepflicht**: Verpflichtender Bestandteil des Lageberichts **für
große Kapitalgesellschaften**

**Prüfungspflicht**

-   Durch Abschlussprüfer verpflichtend im Rahmen der
    Lageberichtsprüfung
-   Ebenfalls vom Aufsichtsrat verpflichtend zu prüfen

**Fallanwendung?**

-   Prüfung ob Unternehmen **mehr als 500 Arbeitnehmer** hat,
    **börsennotiert** ist und/oder ein **Versicherungs- oder
    Kreditinstitut** ist. Falls ja besteht die Pflicht zur Abgabe einer
    **nichtfinanziellen Erklärung** (Bestandteil des Lageberichts oder
    separat)
-   Falls das Unternehmen eine **große Kapitalgesellschaft** ist, muss
    im Rahmen des Lageberichts ebenfalls über **bedeutsame
    nichtfinanzielle Leistungsindikatoren** berichtet werden
-   In der nichtfinanziellen Erklärung muss das Unternehmen mindestens
    die 5 gesetzlich vorgeschriebenen Aspekte behandeln (Umwelt, AN,
    soziales, Menschenrechte, Bestechung und Korruption). Jeder Aspekt
    muss im Hinblick auf **Konzepte und Ergebnisse**, **Risiken die aus
...
Kosten und Nutzen einer freiwilligen CSR Berichtserstattung
===========================================================
...
(\>500 AN + Börsennotierung und/oder Versicherungs- oder Kreditinstitut)
...
**Kosten der CSR Berichtserstattung**
...
-   Indirekte Kosten durch das Preisgeben von Betriebsgeheimnissen und
    sensiblen Unternehmensdaten (Ausnutzung durch Konkurrenz, Kunden
    oder Lieferanten möglich)

**Nutzen der freiwilligen CSR Berichtserstattung**
...
-   Strategische CSR Maßnahmen können gezielt durchgeführt werden, um
    die Reputation des Unternehmens bei **Stakeholdern** zu verbessern
    (als Ergänzung zu Werbekampagnen z.B.)
-   **Shareholder** erhalten umfangreiche und glaubwürdige Informationen
    über die Umsetzung und den Erfolg von strategischen CSR Maßnahmen
...
**Für welche Unternehmen überwiegt der Nutzen einer freiwilligen bzw.
einer umfangreicheren CSR Berichtserstattung die Kosten?**

1.  **Unternehmensgröße: **Die absoluten Kosten der Berichtserstellung
    fallen für große Unternehmen relativ weniger ins Gewicht als für
    kleinere Unternehmen. Große Unternehmen profitieren von
    Skaleneffekten und sind eher bereit die zusätzlichen Kosten zu
    tragen

2.  **Anteilseignerstruktur:** Je höher der Anteil an Shareholdern mit
    hohen sozialen Präferenzen (z.B. hoher Anteil in SRI Fonds oder
    sozialen Stiftungen) desto stärker profitiert Unternehmen
    voraussichtlich von (umfangreicherer) Berichtserstattung

3.  **Geschäftsmodell:**

    a.  Strategische CSR: Hohe Bedeutung für Unternehmen mit engen
        Kundebeziehungen und großem Einfluss des Images (z.B.
        Konsumgüterbranche)
    b.  CSR als Compliance-Aufgabe: Unternehmen aus Branchen mit
        negativen Auswirkungen auf die Allgemeinheit und schlechtem
        Image (z.B. Energiebranche, Rüstung) können signalisieren, dass
        relevante Risiken und ihre Auswirkungen minimiert und adressiert
        wurden

4.  Unternehmen mit hoher/vorbildlicher Aktivität in der CSR Umsetzung
...
Effekte einer verpflichtenden CSR Berichtserstattung
====================================================
...
+----------------------------------+----------------------------------+
| Vorteile einer erweiterten CSR   | Nachteile einer erweiterten CSR  |
| Berichtserstattung               | Berichtserstattung               |
+----------------------------------+----------------------------------+
|                                  |   Keine vollständige             |
|                                  | Harmonisierung                   |
+----------------------------------+----------------------------------+
...
-   Prüfe ob Unternehmen ein „Negativbeispiel" für unzureichende CSR
    Aktivitäten ist, falls ja würde eine erweiterte Verpflichtung
    Anreize dazu setzten die CSR Anstrengungen zu erhöhen
...
**Der AR hat die Geschäftsführung zu überwachen (§111 I AktG)**

Genauer: Überwachung der **strategischen und operativen
Unternehmensführung** durch den **Vorstand** auf **Rechtmäßigkeit,
Ordnungsmäßigkeit und Wirtschaftlichkeit**

**3 Dimensionen der Überwachungsfunktion des AR**

**Rechtmäßigkeit**: Beachtet der Vorstand gesetzliche Vorschriften?
...
**Ordnungsmäßigkeit**: Werden die Arbeitsabläufe im Unternehmen durch
den Vorstand ordnungsmäßig organisiert und überwacht?
...
**Wirtschaftlichkeit: **Ist die Liquidität des Unternehmens
sichergestellt? Werden Ressourcen effizient eingesetzt, um einen
nachhaltigen und langfristigen Ertrag zu erwirtschaften?

Die **Reichweite** der Überwachung des Vorstands durch den AR ergibt
sich primär aus den Berichterstattungspflichten des Vorstands gegenüber
dem AR (§90 I AktG). Der Vorstand berichtet dem AR zwingend über:

-   Unternehmenslage: Geschäfte von wesentlicher Bedeutung und
    allgemeine wirtschaftliche Lage, Umsatz und Rentabilität,
    Geschäftspolitik, Planabweichungen
...
-   Zustimmungsvorbehalte für Geschäfte grundlegender und bedeutender
    Art
...
-   Prüfe ob Ereignis unter die Berichterstattungspflichten des
    Vorstands gegenüber des AR fällt (Unternehmenslage,
    Unternehmensrisiken und Unternehmensplanung)
...
**Beratungsfunktion des AR?**

AktG: Überwachung der Geschäftsführung durch AR

DCGK: Der AR **überwacht und berät** den Vorstand bei der Leitung des
Unternehmens (6 DCGK)
...
**Der Umfang der Beratung liegt jedoch im Ermessensspielraum des AR**
...
**Mitspieler -- Hoher Grad der (zukunftsgerichteten) Beratung des
Vorstands durch AR **

-   Ex Ante: Hoher Grad der Einbindung/ Beratung in die
    Geschäftstätigkeit (z.B. in strategische und operative
    Angelegenheiten)   Umfangreicher Einfluss des AR **vor**
    Vorstandshandlungen
-   Ex Post: Wenn AR ex ante bereits stark involviert ist, ist das
    ...
    Der AR wird hier wenig intervenieren da er sich quasi selbst
    überprüft
...
-   Ex Post: Ergebnis basiert allein auf Vorstandsleistung und der AR
    ist unabhängig davon. Umfangreiche Interventionen und Prüfungen sind
...
**über die Hauptversammlung gewählt. **Der AR schlägt neue
Mitgliedskandidaten auf der HV vor**. **Nach **DCGK **wird eine**
Einzelwahl der Mitglieder empfohlen**

Nach Wahl durch die HV darf ein AR Mitglied **eine maximale Amtsperiode
von 5 Jahren antreten**, die **Wiederbestellung ist grundsätzlich
möglic**h nach erneuter Wahl durch die HV
...
-   Prüfe ob Unternehmen mehr als 500 AN hat und nicht unter das
    MitbestG fällt? Drittbeteiligungsgesetz!
-   Prüfe für Unternehmen, die dem MitbestG unterliegen die Anzahl der
    AN und der resultierenden Anzahl an AR Mitgliedern (50% AN-Vertreter
    und 50% Aktionärsvertreter, Aktionärsvertreter wählen den
    AR-Vorsitzenden)
-   Falls das Unternehmen nach MitbestG börsennotiert ist, muss
    zusätzlich die gesetzliche Geschlechterquote bei der Besetzung des
    AR eingehalten werden (min 30% pro Geschlecht)

**Effekt der Aufsichtsratsgröße**

Tendenz von Unternehmen die AR zu verkleinern, große AR haben zwei
primäre Nachteile

1.  Koordinationsprobleme: Kommunikation und Zielabstimmung werden mit
    zunehmender Zahl an Mitgliedern überproportional erschwert
2.  Free Rider Problem: Die Kosten der Anstrengung (z.B. einer
    notwendigen Kritik) trägt ein einzelnes AR Mitglied eigenständig,
    die Vorteile dieser Anstrengung trägt jedoch der ganze AR bzw. das
    Unternehmen. Einzelnes AR Mitglied hat also Anreiz nicht tätig zu
    werden da der Nutzen größer ist, wenn er auf die Aktion eines
    anderen Mitglieds wartet

**Lösungen zur Problematik großer Aufsichtsräte?**
...
-   Einrichtung prinzipiell möglich zur Vorbereitung und Überwachung
    unter der Auflage das regelmäßig an den restlichen AR berichtet wird
    und die letztendliche Entscheidung in Form der Beschlussfassung bei
    wichtigen Aufgaben ebenfalls durch den gesamten AR erfolgt

  Der gesamte AR trägt Letztverantwortung trotz Ausschussbildung

**Ausnahme**: P**rüfungsausschuss des AR** für die Überwachung von IKS,
Rechnungslegung ist durch **AktG vorgeschrieben** (DCGK Empfehlung:
ebenfalls Überwachung der Compliance Aufgabe)
...
**Weitere mögliche AR Ausschüsse**

Personalausschuss zur **Vorbereitung** der Auswahl des Vorstands,
Vergütungsausschuss zur **Vorbereitung** der Festlegung der
Vergütungsansprüche, Strategieausschüsse, Präsidialausschüsse
(Vorbereitung von Sitzungen), Vermittlungsausschuss etc.

**Fallanwendung**?

-   Prüfe ob AR groß ist (ca. ab 16 Mitgliedern) und ob den
    Problematiken großer AR durch das Bilden von Ausschüssen
...
Mitbestimmung -- Anteilseigner-Vertreter im AR
==============================================
...
**Shareholder**: Anspruch auf Residualgewinn (=Unternehmensumsatz-
...
-   Ermittle alle Stakeholder Gruppen, die durch Vorstandshandlungen
    negativ beeinflusst werden könnten (Gesellschaft bei Umweltschaden,
    AN bei Stellenabbau, Aktionäre bei Gewinneinbußen)
-   Ermittle rechtliche und vertragliche Absicherungen der
    Stakeholdergruppen (exklusive Shareholder): Arbeitsschutzgesetzte
    für AN; Umweltschutzgesetze für Gesellschaft
-   Shareholder können sich gegen das Risiko einer Minderung ihres
    Returns nicht vertraglich absichern, da sie das unternehmerische
    Risiko tragen. Eine Absicherung und Interessensvertretung der
    Aktionäre durch Vertreter im AR kann daher eine wichtige Funktion in
    der Sicherstellung der Profitabilität des Unternehmens darstellen
    (ebenfalls wichtig für sonstige Stakeholder)

Mitbestimmung -Arbeitnehmervertreter im AR
==========================================
...
Hauptproblem: **Hold Up Probleme bei der Tätigung von firmenspezifischen
Investitionen** durch Arbeitnehmer
...
opportunistisch von ihr
  ...
  Arbeitnehmer antizipiert dieses Verhalten des Arbeitgebers und
vermeidet die firmenspezifische Investition ohne Absicherungsmechanismus
...
**Weitere Vorteile der AN-Vertretung im AR**

-   Hohes firmenspezifisches Wissen und Kenntnisse der internen Abläufe
    ermöglichen effektivere **Überwachung** (von Schwachpunkten) und
    hilfreiche **Beratung** des Vorstands
-   **Kontakt** zwischen AN und AG wird gefördert, AN werden als
    wichtiger Produktionsfaktor stärker an das Unternehmen gebunden

Eine **Vermeidung der Mitbestimmung** durch Unternehmen wird häufig
beobachtet, Möglichkeiten dazu sind das „**klein bleiben"** (\<2.000AN),
die **Teilung des Unternehmens**, der **Wechsel von AG zu SE** vor
Überschreitung der Schwelle oder das einfache (unrechtmäßige)
...
-   Beschreibe Mitbestimmung als Lösungsmöglichkeit des Hold Up Problems
    und erwähne die weiteren Vorteile einer AN Vertretung im AR
    (Kontakt, Überwachung und Beratung)

Voraussetzungen für AR Mitglieder
=================================

Kompetenzprofil
---------------

**Einzelnes AR Mitglied:**

-   Natürliche Person mit unbeschränkter Geschäftsfähigkeit

-   Voraussetzung zur persönlichen und eigenverantwortlichen Ausübung
    der AR Tätigkeit: Grundlegende Kenntnisse der Rechte und Pflichten
    aller Unternehmensorgane und grundlegende Kenntnisse der
...
-   Spezifische Kenntnisse leiten sich aus dem konkreten Aufgabenbereich
    ...
    -   Controlling Kenntnisse zur Beurteilung der Wirtschaftlichkeit
        etc.
...
-   Prüfe ob alle Mitglieder grundlegende Kenntnisse der Rechte und
    Pflichten der Unternehmensorgane sowie grundlegende Kenntnisse der
    BWL zur persönlichen und eigenverantwortlichen Ausübung der AR
    Tätigkeit besitzen

**Spezifische Anforderung für AR Mitglieder des Prüfungsausschusses
gemäß AktG §100 V**

-   Mindestens 1 Mitglieder verfügt über Sachverstand auf dem Gebiet der
    Rechnungslegung oder Abschlussprüfung
-   Prüfungsausschuss-Mitglieder müssen insgesamt mit dem Sektor
    vertraut sein, in dem das Unternehmen tätig ist (z.B. Erfahrung in
    Automobilbranche für Automobilhersteller)

Zur Sicherstellung eines AR, der insgesamt über alle erforderlichen
Spezialkompetenzen verfügt, sollen gemäß **DCGK Empfehlungen
Kompetenzprofile** für jedes einzelne Mitglied erarbeitet werden

Ziele bei Gesamtzusammensetzung des AR **gemäß DCGK**:
...
Determinanten der **Kompetenzprofile** einzelner Mitglieder des AR
**gemäß DCGK**:
...
**Grundidee der AR Kompetenzprofile?**
...
-   Nicht jedes AR Mitglied muss alle Kompetenzen aufweisen, es geht
    immer um die Gesamtzusammensetzung des AR
...
**Kompetenz** ebenfalls die **Unabhängigkeit**

**Kompetenz: **Ermöglicht die Analyse des Vorstandshandel auf
Rechtmäßigkeit, Ordnungsmäßigkeit und Wirtschaftlichkeit

**Unabhängigkeit**: Angemessene Reaktion auf festgestellte Probleme im
Interesse der Gesamtgesellschaft

**Rechtliche Vorgaben zur Unabhängigkeit gemäß AktG**

Unabhängigkeit wird insbesondere anhand der institutionelle Trennung
definiert:

1.  Vorstandsamt und Aufsichtsratsamt innerhalb der gleichen
    Gesellschaft ist nicht möglich

    a.  Gilt für Konzerne und Tochtergesellschaften (abhängige
        Gesellschaften) ebenfalls

2.  Verbot von Überkreuzprüfungen (A ist Vorstand in Unternehmen X und
    AR in Unternehmen Y, B ist AR in Unternehmen X und Vorstand in
    Unternehmen Y)
...
**Empfehlungen nach DCGK**

-   Prinzipiell muss nicht jedes einzelne AR Mitglied unabhängig sein
-   **Mehr als die Hälfte der Anteilseignervertreter sind unabhängig
    (von Gesellschaft und Vorstand)**
-   **Vorsitzender des AR, des Prüfungsausschuss und des
    Vergütungsausschuss sind unabhängig**

Unabhängigkeit gemäß DCGK: AR Mitglied steht in **keiner persönlichen
oder geschäftlichen Beziehung zu der Gesellschaft und dem Vorstand**
durch die ein **wesentlicher** und **nicht nur vorübergehender
Interessenskonflikt** begründet wird

Prüfung der Unabhängigkeit erfolgt anhand von Indikatoren, die für jedes
AR Mitglied zu überprüfen sind

**DCGK 4 Indikatoren der Unabhängigkeit**

1.  Persönliche Beziehung: AR Mitglied ist naher Familienangehöriger
    eines Vorstandsmitglieds

2.  Tätigkeit im AR seit über 12 Jahren

3.  AR Mitglied ist direkt oder als Gesellschafter an einem anderen
    Unternehmen beteiligt, dass wesentliche Geschäftsbeziehungen zu dem
    Unternehmen unterhält (aktuell oder bis zum Jahr der Ernennung als
    AR unterhalten hat)

4.   AR Mitglied war innerhalb der zwei Jahre vor seiner Ernennung
    selbst Vorstandsmitglied der betroffenen Gesellschaft
  ...
  Erfüllung eines Indikators deutet auf fehlende Unabhängigkeit hin,
führt aber nicht zwingend dazu. Falls Mitglied trotz Erfüllung als
unabhängig aufgeführt werden soll, muss dies Erläutert und begründet
werden

**Ergänzende Empfehlungen nach DCGK**

-   Falls das Unternehmen einen kontrollierenden Aktionär[^3] hat, soll
    mindestens ein AR Mitglied unabhängig von diesem sein (falls 6+
    Mitglieder im AR dann sollen mindestens 2 AR Mitglieder unabhängig
    vom kontrollierenden Aktionär sein)
-   Offenlegung von Anzahl und Namen aller als unabhängig eingestufter
    AR Mitglieder offenlegen

**Verhältnis von abhängigen und unabhängigen AR Mitgliedern?**
...
-   Mindestens die Hälfte der Anteilseignervertreter sollen unabhängig
    sein falls es **keinen kontrollierenden Aktionär** gibt
...
-   Prüfe ob die gesetzliche Unabhängigkeitsanforderungen erfüllt sind
    ...
    -   AR Mitglieder sind nicht gleichzeitig Vorstandsmitglieder (gilt
        auch für abhängige Gesellschaften)
    -   Früher Vorstandsmitglieder erfüllen die 2-jährige Cool -Off
        Wartefrist (Ausnahme bei 25% Stimmen der Hauptversammlung)
    -   Keine Überkreuzbeziehungen in dem AR Mitglied und
        Vorstandsmitglied in zwei Gesellschaften über Kreuz sich
...
**Trade Off -- Wechsel von Vorstand in AR**
...
-   Pro: Ehemaliges Vorstandsmitglied bringt sehr viele
    firmenspezifische Kenntnisse in den AR mit ein.
...
Ausübung des AR Amt nicht verletzt wird gilt eine Beschränkung auf **die
maximale Ausübung von 10 Aufsichtsratsmitgliedschaften** in
...
-   Maximal 5 AR Ämter (inklusive vergleichbarer Posten im Ausland)
    zeitgleich für sämtliche AR Mitglieder die kein Vorstandsamt
    bekleiden
...
**Reglung des AktG**: Angemessene Vergütung von AR Amt in Anbetracht von

1.  Aufgaben des AR Mitglieds
2.  Lage der Gesellschaft (insbesondere Größe z.B. SDAX\<MDAX\<DAX für
    Median AR-Vergütung)
...
Funktion der Hauptversammlung (Kurzform)
========================================

1.  Die HV ermöglicht es den Aktionären die **koordinierte Ausübung
    ihrer Stimmrechte** **gewichtet nach dem Anteil ihres
    Aktienbesitzes** auszuüben. *Direkt* stimmen die Aktionäre über die
    **Bestellung der AR Mitglieder und des Abschlussprüfers** ab
    (indirekt kann die HV dadurch auch Einfluss auf die
    **Unternehmensleitung** ausüben indem die **Überwachung** **dieser
    *****delegiert*** wird). Einen direkten Einfluss auf
    unternehmerische Entscheidungen kann die HV nur im Rahmen der
    **Gewinnverwendung (Höhe der Dividendenzahlung**) sowie bei
    **wesentlichen Strukturentscheidungen** nehmen. Weiterhin können
    Aktionäre im Rahmen der Billigung von Vergütungsmechanismen und der
    Entlastung des Vorstands ihre *Meinung* zum Ausdruck bringen

**Daten zur HV**: Jährlicher Turnus, Leitung durch AR Vorsitzenden, DCGK
Empfehlungen: 4-6 Stunden maximale Dauer

**Direkte Einflussnahme der HV**: Verwendung des Bilanzgewinns,
grundlegende Strukturentscheidungen (Satzungsänderungen,
Kapitalbeschaffung und Herabsetzung, Auflösung der Gesellschaft)

**Delegation der Einflussnahme durch HV: **Bestellung von Aufsichtsrat,
Abschlussprüfer und falls notwendig auch Sonderprüfern

**Billigung (=Meinungsäußerungen der HV): **Entlastung von Vorstand und
AR, Votum über Vergütungsystem

**Stimmrechte**: 1 Stimme pro Aktie, grundsätzlich einfache Mehrheit jedoch qualifizierte Mehrheit (ab 75%) für Satzungsänderungen, Vorstand ist verpflichtet zur Umsetzung, Wahloptionen je nach Thema durch AR oder Vorstand

1.  Die Hauptversammlung beinhaltet eine **Diskussion der Tagesordnungspunkte**, Aktionäre besitzen dabei ein **Rede- und
    Auskunftsrecht. Vorstand hat Fragen zu beantworten** unter der
    Bedingung, dass diese mit dem entsprechenden **Tagesordnungspunkt
    zusammenhängen** und dass das **Unternehmen keinen Schaden durch die
    Beantwortung erleidet**. Aktionäre können außerdem **Gegenanträge
    zur Tagesordnung** stellen und bei einer ausreichenden **Mehrheit
    die Tagesordnung um weitere Punkte erweitern**. Auch eine
    **außerordentliche Hauptversammlung** kann bei Mehrheiten einberufen
    werden
...
Tagesordnung durch Aktionärsgruppe mit 5% Grundkapital oder 500 000 Euro
Aktionärskapital (z.B. Beauftragung von Sonderprüfern), Einberufung
einer außerordentliche HV von Aktionärsgruppe mit 5% Grundkapital

1.  Für Kleinaktionäre ist die Ausübung des Stimmrechts i.d.R.
    irrational, da der Aufwand, den für sie zu erwartetem Nutzen,
    übersteigt. Häufig wird eine Art von „Durchwinken" der
    Tagesordnungspunkte der bei Abstimmungen der HV beobachtet. Negative
    Meinungsäußerungen und geringe Zustimmungsquoten der Aktionäre
    können jedoch großen Einfluss auf die Unternehmensleitung haben und
    werden von diesen regelmäßig sehr ernst genommen
...
Vorstands oder einer Verringerung der Vergütung des Vorstands)
  ...
  Aktionäre übe rn geringen unmittelbaren Einfluss aus aber durchaus
hohen mittelbaren, indirekten Einfluss
...
## Governance in Public-Private Partnerships ans NGOs

Main Topic: What are the challenges and differences of (Corperate) Governance in public sector organizations and NGOs?

#### Governance in the public sector (p1)
...
Why the need for CG in public sector?
> ensure, that  organizations fulfill their job and purpose to the public that largely funds them

Important elements in public sector governance include:

1. internal structures (boards, sub-committees, ..)
2. external accountability (financial budgets, reports, ..)
...
* Private: 
	1. Stakeholders as the main focus group for accountability
	2. "classic" agency problem
* public sector:
	1. Agency problem with different properties, principals are very divers group made of  members of society
	2. Who are the main people that public sector organizations should be accountable to?
	3. Constanly changing environment (stupid slide)


##### NPM Reforms of 1980s

* New Public Management (=NPM) is a managemnt philosophy that is getting more adapted by publi organizations since the 1980. 
* Aim: Enhance Efficiency, Productivity and Quality of public organizations
* Focus: Market orientations and reforms to mirror the management and organization style of private sector companies
...
Similiar questions as in public sector organizations, 
	1. Who are the shareholders?
	2. how to measure accountability?
...
* Difficult since the metric is outside of the organization (much easier for private companies)
* Hard to collect and interpret data for accountability in many cases
* Different metrics are used but flawd
	* cost per total expenditure: how many percent of a donation are spend on aim, costs, ...
	* SROI - Social Return on Investment: Estimates socials value generated dollar equivalent
